...
def check(email):
    url = "https://qyeulj9nak.execute-api.us-west-2.amazonaws.com/plasma/getdata?email=" + email
...
def register():
    ...
    if ('errorType' in check(x[1])):
        url = "https://qyeulj9nak.execute-api.us-west-2.amazonaws.com/plasma/registration?" + params
...
@app.route('/stats')
def stats():
    url = "https://qyeulj9nak.execute-api.us-west-2.amazonaws.com/plasma/getbloodgroupdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    # print(bloodgrp)
    url = "https://qyeulj9nak.execute-api.us-west-2.amazonaws.com/plasma/requestonbloodgroup?blood=" + bloodgrp
    ...
    phone = []
    for i in a:
        url = "https://www.fast2sms.com/dev/bulk?authorization=T4lGBF7h1RXgAfvKsoLWiCtrm2O9NeZw8EDqHj5uad0SPYVnpkaLExWXSmlrtsfdUGC2JigVBQjy6cwq&sender_id=FSTSMS&message=This is test message&language=english&route=p&numbers=" + str(i['phone'])
